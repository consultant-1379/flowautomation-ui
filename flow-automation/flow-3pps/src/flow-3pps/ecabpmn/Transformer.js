...
define([], function () {
  ...
  Transformer.prototype.transform =  function(source) {
    ...
    function transformDocumentation(element, scope, bpmnDiElementIndex) {
        var docObject = createBpmnObject(element, scope, bpmnDiElementIndex);
        docObject.documentation = element.textContent;
        return docObject;
      }
    ...
    function transformScope(scopeElement, scopeActivity, bpmnDiElementIndex) {
      ...
      do {
        ...
        } else if(elementType == "documentation"){
            bpmnObject = transformDocumentation(element, scopeActivity, bpmnDiElementIndex);
