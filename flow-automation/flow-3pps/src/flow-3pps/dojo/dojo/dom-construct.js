define(["./_base/kernel", "./sniff", "./_base/window", "./dom", "./on", './dom-style', "./_base/lang", "./_base/connect"],
		function(dojo, has, win, dom,on, style, lang, conn){
	// module:
	//		dojo/dom-construct
	// summary:
	...
	attr.set = set = function setAttr(/*DOMNode|String*/ node, /*String|Object*/ name, /*String?*/ value){
		node = dom.byId(node);
